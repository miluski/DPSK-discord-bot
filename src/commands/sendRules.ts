...
export class SendRulesCommand {
    ...
    private readonly rulesArray: Array<Rule> = [
        ...
        {
            name: "Zasada 4",
            value: "Oferty pomocy przy developie aplikacji będą z reguły odrzucane - team developerski został wybrany na samym początku tworzenia aplikacji i na tym etapie jej rozwoju wolimy nie wpuszczać w swoje szeregi nowych osób. Jednakże, nie wykluczamy opcji przyjęcia kogoś nowego do grona.",
        },
        {
            name: "Zasada 5",
    ...
    constructor(interaction: CommandInteraction<CacheType>) {
        ...
        this.execute().catch(error => {
            console.error("Error executing SendRulesCommand:", error);
        });
    }
    ...
    private getRulesEmbed(): EmbedBuilder {
        try {
            ...
            console.error("Error generating rules embed:", error);
            throw error;
        }
    }
}
